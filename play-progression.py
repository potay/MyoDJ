...
class MingusHub(Myo.MyoHub):
    def init(self):
        self.SF2Index = 0
        self.SF2List = ["soundfont.sf2", "Analog Age_set.sf2", "HeavyDTWaves.SF2", "jonnypad10.sf2", "space_wings.SF2"]
        ...
        self.Song = MidiSong.MidiSong('sample_midi/DukeSingleLonger.mid')
